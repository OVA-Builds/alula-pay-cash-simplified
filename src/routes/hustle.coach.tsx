...
const STEPS = [
  {
    letter: "b",
    icon: Boxes,
    title: "Ingredients or Supplies?",
    body: "First thing every time you log a day: tell us whether this business runs on ingredients (food, drink) or supplies (equipment, stock, materials). It shapes how your costs get tracked.",
  },
  {
    letter: "c",
    icon: Banknote,
    title: "What did it cost you?",
    body: "Enter what you actually spent on ingredients or supplies for that day. Be honest here — this is the number everything else gets measured against.",
  },
  {
    letter: "d",
    icon: ListPlus,
  ...
  },
  {
    ...
    body: "What did you actually walk away with after everything above? This is the number that builds your business's track record over time.",
  },
  {
    letter: "f",
    icon: PiggyBank,
    title: "Choose how much to save",
    body: "Pick a percentage of today's profit to put aside — even 10% adds up. This is what turns a good day into long-term progress instead of just cash that comes and goes.",
  },
  {
    letter: "g",
    icon: PieChart,
      ...
      <div className="min-h-screen bg-neutral-950 pb-10">
        <div className="relative overflow-hidden bg-gradient-to-br from-neutral-900 via-neutral-950 to-black pb-8 pt-8">
          ...
          <div className="relative mt-5 px-6">
            ...
            <h1 className="mt-3 text-2xl font-bold tracking-tight text-white">Running your Business Health Dashboard.</h1>
        ...
        <div className="-mt-4 space-y-3 rounded-t-[2rem] bg-background p-6 shadow-[0_-12px_40px_rgba(0,0,0,0.35)]">
          {STEPS.map((s) => {
            const Icon = s.icon;
            return (
